...
const MultiStepForm = () => {
  ...
  const handleResumeForm = async () => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      if (
        extendedFormFields["businessEntity"] &&
        extendedFormFields["businessEntity"].trim() !== ""
      ) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (querySnapshot.empty) {
        ...
        setMessage(
          "You're pre-approved. Complete a few final details to secure your funds."
        );
        setPreApproved(true);
      } else {
                  ...
                  >
                    ...
                    >
                      <Typography
                        ...
                        component="h2"
                      >
                        Enter your email address to continue from where you left
                        off
                      </Typography>
                      <TextField
                        fullWidth
                  ...
                  {[
                    ...
                    <Grid item xs={6} sm={6} key={revenue}>
                      <Button
                        ...
                        fullWidth
                        className={`time-period-button ${
                          monthlyRevenue === revenue ? "selected" : ""
                        }`}
                ...
                <Grid container columnSpacing={2} className="grid-layout">
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      helperText={
                        errors.businessName && "This field cannot be empty"
                      }
                    />
                  </Grid>
                ...
                <FormControlLabel
                  ...
                  label={
                    <Typography variant="body2">
                      By selecting "Get Loan Offers" you agree to our{" "}
                      <a
                        href="https://www.klendify.com/privacy-policy"
                        target="_blank"
                      >
                        Privacy Policy
                      </a>
